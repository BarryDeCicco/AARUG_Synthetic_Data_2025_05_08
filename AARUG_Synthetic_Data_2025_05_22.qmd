...
-   The R ackage: synthpop will be used as a demonstration here ([synthpop: Bespoke Creation of Synthetic Data in R (Nowok, Raab, Dibbern)](https://cran.r-project.org/web/packages/synthpop/vignettes/synthpop.pdf) . This was developed in the UK, to deal with certain surveys.
